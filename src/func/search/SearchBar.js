...
// function SearchBar({ fileManager, files = true, directories = true, rows, advanced = true, search = true, placeholder = "Search", onSelect, onEnter, onOptionsChanged, onChange }) {
...
function SearchBar({ fileManager, files = true, directories = true, rows, advanced = true, search = true, placeholder = "Search", onSelect, onEnter, onOptionsChanged, onChange }) {
    ...
    }, [fileManager, directories, advanced, rows]); // Added dependencies here
